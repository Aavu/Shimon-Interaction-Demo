...
class AudioMidiConverter:
    ...
    def convert(self, y, return_duration=False):
        ...
        if return_duration:
            return notes, np.diff(onsets, prepend=0)
    ...
    def filter_raga(self, _notes):
        ...
        _n = _notes - self.root
        code = (_n + 12) % 12
        filtered_notes += self.raga_map[code] - code
